...
1. Clone repository and open directory which contains Pipfile.lock in vscode (or other IDE)
...
5. Navigate to ParkingProject folder which contains manage.py, and create .env file.
6. Add line 'SECRET_KEY=your-generated-secret-key' in the .env file
